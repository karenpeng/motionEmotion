...
define("Tone/core/Tone", [], function () {
		...
		var noteIndexToNote = ["A", "A#", "B", "C", "C#", "D", "D#", "E", "F", "F#",
				"G", "G#"
		];
...
define('Tone/core/Master', ["Tone/core/Tone"], function (Tone) {
		...
		Master.prototype.setVolume = function (value, fadeTime) {
				...
				if (fadeTime) {
						...
						this.output.gain.linearRampToValueAtTime(value, now + this.toSeconds(
								time));
				} else {
...
define('Tone/signal/Signal', ["Tone/core/Tone", "Tone/core/Master"], function (
		Tone) {
		 ...
		 *  @param  {Tone.Time} endTime
		 */
		Tone.Signal.prototype.exponentialRampToValueAtTime = function (value,
				endTime) {
				value *= this._syncRatio;
				this.scalar.gain.exponentialRampToValueAtTime(value, this.toSeconds(
						endTime));
		};
		...
		Tone.Signal.prototype.exponentialRampToValueNow = function (value, endTime) {
				...
				this.scalar.gain.exponentialRampToValueAtTime(value, now + this.toSeconds(
						endTime));
		};
		...
		Tone.Signal.prototype.linearRampToValueNow = function (value, endTime) {
				...
				this.scalar.gain.linearRampToValueAtTime(value, now + this.toSeconds(
						endTime));
		};
		 ...
		 */
		Tone.Signal.prototype.setTargetAtTime = function (value, startTime,
				timeConstant) {
				value *= this._syncRatio;
				this.output.gain.setTargetAtTime(value, this.toSeconds(startTime),
						timeConstant);
		};
		 ...
		 */
		Tone.Signal.prototype.setValueCurveAtTime = function (values, startTime,
				duration) {
				for (var i = 0; i < values.length; i++) {
						values[i] *= this._syncRatio;
				}
				this.scalar.gain.setValueCurveAtTime(values, this.toSeconds(startTime),
...
define('Tone/signal/Add', ["Tone/core/Tone", "Tone/signal/Signal"], function (
		Tone) {
...
define('Tone/signal/Scale', ["Tone/core/Tone", "Tone/signal/Add",
		"Tone/signal/Multiply"
], function (Tone) {
		...
		Tone.Scale = function (inputMin, inputMax, outputMin, outputMax) {
			...
			@type {Tone.Add} */
				...
				//connections
				this.chain(this.input, this._plusInput, this._scale, this._plusOutput,
						this.output);
		...
		Tone.Scale.prototype._setScalingParameters = function () {
				...
				this._scale.setValue((this._outputMax - this._outputMin) / (this._inputMax -
						this._inputMin));
...
define('Tone/component/DryWet', ["Tone/core/Tone", "Tone/signal/Signal",
		"Tone/signal/Scale"
], function (Tone) {
...
define('Tone/component/Envelope', ["Tone/core/Tone", "Tone/signal/Signal"],
		function (Tone) {
				 ...
				 */
				Tone.Envelope = function (attack, decay, sustain, release, minOutput,
						maxOutput) {
						//extend Unit
						Tone.call(this);
				...
				Tone.Envelope.prototype.triggerAttack = function (time) {
						...
						if (!time) {
								...
								this.control.linearRampToValueAtTime(sustainVal, this.now() + this.attack +
										this.decay);
						} else {
								...
								this.control.linearRampToValueAtTime(sustainVal, time + this.attack +
										this.decay);
						}
				};
				...
				Tone.Envelope.prototype.triggerRelease = function (time) {
						if (time) {
								...
								this.control.cancelScheduledValues(time);
								this.control.setValueAtTime(startVal, time);
								this.control.linearRampToValueAtTime(this.min, time + this.toSeconds(
										this.release));
						} else {
				...
				Tone.Envelope.prototype.triggerExponentialRelease = function (time) {
						if (time) {
								...
								this.control.cancelScheduledValues(time);
								this.control.setValueAtTime(startVal, time);
								this.control.exponentialRampToValueAtTime(this.min, time + this.toSeconds(
										this.release));
						} else {
...
define('Tone/signal/Negate', ["Tone/core/Tone", "Tone/signal/Multiply"],
		function (Tone) {
...
define('Tone/signal/EqualZero', ["Tone/core/Tone", "Tone/signal/Threshold"],
		function (Tone) {
...
define('Tone/signal/Abs', ["Tone/core/Tone", "Tone/signal/Threshold",
		"Tone/signal/Negate", "Tone/signal/EqualZero"
], function (Tone) {
...
define('Tone/component/Follower', ["Tone/core/Tone", "Tone/signal/Abs",
		"Tone/signal/Negate", "Tone/signal/Threshold"
], function (Tone) {
		...
		Tone.Follower = function (attackTime, releaseTime) {
				...
				this.chain(this._difference, this._thresh, this._frequencyValues, this._filter
						.frequency);
				//set the attack and release values in the table
				this._setAttackRelease(this.secondsToFrequency(attackTime), this.secondsToFrequency(
						releaseTime));
		};
...
define('Tone/core/Transport', ["Tone/core/Tone", "Tone/core/Master",
				"Tone/signal/Signal"
		],
		function (Tone) {
				...
				Tone.Transport.prototype.start = function (time) {
						if (this.state === TransportState.STOPPED || this.state ===
				...
				Tone.Transport.prototype.stop = function (time) {
						if (this.state === TransportState.STARTED || this.state ===
								TransportState.PAUSED) {
								this.state = TransportState.STOPPED;
				...
				Tone.Transport.prototype.setBpm = function (bpm, rampTime) {
						...
						var tatumFreq = this.secondsToFrequency(this.notationToSeconds(tatum.toString() +
								"n", bpm, transportTimeSignature));
				 ...
				 */
				Tone.Transport.prototype.setTimeSignature = function (numerator,
						denominator) {
				 ...
				 *  @param {Tone.Time} endPosition
				 */
				Tone.Transport.prototype.setLoopPoint = function (startPosition,
						endPosition) {
				...
				Tone.prototype.isTransportTime = (function () {
						var transportTimeFormat = new RegExp(
								/^\d+(\.\d+)?:\d+(\.\d+)?(:\d+(\.\d+)?)?$/);
				 ...
				 */
				Tone.prototype.transportTimeToSeconds = function (transportTime, bpm,
						timeSignature) {
						bpm = this.defaultArg(bpm, Tone.Transport.getBpm());
						timeSignature = this.defaultArg(timeSignature, transportTimeSignature);
						var measures = 0;
...
define('Tone/source/Source', ["Tone/core/Tone", "Tone/core/Transport"],
		function (Tone) {
				/**
...
define('Tone/source/Oscillator', ["Tone/core/Tone", "Tone/core/Transport",
				"Tone/signal/Signal", "Tone/source/Source"
		],
		function (Tone) {
				...
				Tone.Oscillator = function (freq, type) {
						 ...
						 *  @type {Tone.Signal}
						 */
						this.frequency = new Tone.Signal(this.defaultArg(this.toFrequency(freq),
								440));
				...
				Tone.Oscillator.prototype.setFrequency = function (val, rampTime) {
						if (rampTime) {
								this.frequency.exponentialRampToValueAtTime(this.toFrequency(val), this
										.toSeconds(rampTime));
						} else {
...
define('Tone/component/LFO', ["Tone/core/Tone", "Tone/source/Oscillator",
		"Tone/signal/Scale"
], function (Tone) {
		...
		Tone.LFO = function (rate, outputMin, outputMax) {
			...
			@private
		*/
				this._scaler = new Tone.Scale(this.defaultArg(outputMin, 0), this.defaultArg(
						outputMax, 1));
...
define('Tone/component/Meter', ["Tone/core/Tone", "Tone/core/Master"], function (
		Tone) {
		...
		Tone.Meter = function (channels, smoothing, clipMemory) {
				 ...
				 *  @type {ScriptProcessorNode}
				 */
				this._jsNode = this.context.createScriptProcessor(this.bufferSize, this.channels,
						1);
...
define('Tone/component/Panner', ["Tone/core/Tone", "Tone/component/DryWet",
				"Tone/signal/Merge", "Tone/signal/Split"
		],
		function (Tone) {
...
define('Tone/component/Recorder', ["Tone/core/Tone", "Tone/core/Master"],
		function (Tone) {
				 ...
				 *  @private
				 */
				Tone.Recorder.prototype._recordChannels = function (inputBuffer, from, to,
						bufferSize) {
				...
				Tone.Recorder.prototype.getAudioBuffer = function () {
						if (this.isEmpty()) {
								...
								var audioBuffer = this.context.createBuffer(this.channels, this._recordBuffers[
										0].length, this.context.sampleRate);
...
define('Tone/effect/Effect', ["Tone/core/Tone", "Tone/component/DryWet"],
		function (Tone) {
...
define('Tone/effect/AutoPanner', ["Tone/core/Tone", "Tone/effect/Effect",
		"Tone/component/LFO", "Tone/component/Panner"
], function (Tone) {
...
define('Tone/effect/FeedbackEffect', ["Tone/core/Tone", "Tone/effect/Effect",
		"Tone/signal/Signal"
], function (Tone) {
		/**
...
define('Tone/effect/FeedbackDelay', ["Tone/core/Tone",
		"Tone/effect/FeedbackEffect", "Tone/signal/Signal"
], function (Tone) {
		/**
		 *  A feedback delay
		 *
		 ...
		 */
		Tone.FeedbackDelay.prototype._feedbackEffectDispose = Tone.FeedbackEffect.prototype
				.dispose;
...
define('Tone/effect/PingPongDelay', ["Tone/core/Tone",
		"Tone/effect/FeedbackDelay", "Tone/signal/Split", "Tone/signal/Merge"
], function (Tone) {
		/**
...
define('Tone/signal/Equal', ["Tone/core/Tone", "Tone/signal/EqualZero",
		"Tone/signal/Add"
], function (Tone) {
...
define('Tone/signal/Gate', ["Tone/core/Tone", "Tone/signal/Signal",
...
define('Tone/signal/GreaterThan', ["Tone/core/Tone", "Tone/signal/Threshold"],
		function (Tone) {
...
define('Tone/signal/LessThan', ["Tone/core/Tone", "Tone/signal/GreaterThan"],
		function (Tone) {
...
define('Tone/source/Microphone', ["Tone/core/Tone", "Tone/source/Source"],
		function (Tone) {
						...
						MediaStreamTrack.getSources(function (media_sources) {
								if (inputNum < media_sources.length) {
										self.constraints.audio = {
												optional: [{
														sourceId: media_sources[inputNum].id
												}]
										};
								}
						});
...
define('Tone/source/Noise', ["Tone/core/Tone", "Tone/source/Source"], function (
		Tone) {
...
define('Tone/source/Player', ["Tone/core/Tone", "Tone/source/Source"], function (
		Tone) {
		...
		Tone.Player.prototype.start = function (startTime, offset, duration) {
				if (this.state === Tone.Source.State.STOPPED || this.retrigger) {
						if (this._buffer) {
								...
								this.chain(this._source, this.output);
								//start it
								this._source.start(this.toSeconds(startTime), this.toSeconds(offset),
										this.toSeconds(duration));
						}
				}
		};
		...
		Tone.Player.prototype.setPlaybackRate = function (rate, rampTime) {
				...
				if (this._source) {
						if (rampTime) {
								this._source.playbackRate.exponentialRampToValueAtTime(rate, this.toSeconds(
										rampTime));
						} else {
